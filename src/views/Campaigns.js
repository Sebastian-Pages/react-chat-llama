...
export const CampaignsComponent = () => {
  ...
  return (
    <>
      ...
      <CreateCampaignCard onCreate={create_new_campaign}/>

      <div className="card-container">
      {Object.entries(campaigns).map(([campaignId, campaignData]) => (
        <CampaignCard
          key={campaignId}
...
export default withAuthenticationRequired(CampaignsComponent, {
